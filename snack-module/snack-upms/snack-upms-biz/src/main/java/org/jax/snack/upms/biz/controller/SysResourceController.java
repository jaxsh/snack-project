 ...
 */
@RestController
@RequestMapping("/api/upms/resources")
...
public class SysResourceController {
	 ...
	 */
	@PostMapping
	public void create(@Validated(Create.class) @RequestBody SysResourceDTO dto) {
	 ...
	 */
	@GetMapping("/{id}")
	public PageResult<SysResourceVO> getById(@PathVariable Long id) {
		QueryCondition condition = QueryCondition.builder().eq(SysResource.Fields.id, id).build();
	 ...
	 */
	@PostMapping("/query")
	public PageResult<SysResourceVO> query(@RequestBody QueryCondition condition) {
		return this.service.queryByDsl(condition);
	}
	 ...
	 */
	@PutMapping("/{id}")
	public void update(@PathVariable Long id, @Validated(Update.class) @RequestBody SysResourceDTO dto) {
	...
	public void delete(@PathVariable List<Long> ids) {
		WhereCondition condition = WhereCondition.builder().in(SysResource.Fields.id, ids).build();
	 ...
	 */
	@GetMapping("/tree")
	public List<TreeNode<SysResourceVO>> tree() {
