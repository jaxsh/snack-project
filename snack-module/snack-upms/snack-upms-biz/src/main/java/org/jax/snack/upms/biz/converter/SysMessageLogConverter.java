...
public interface SysMessageLogConverter extends BasePageConvert<SysMessageLog, SysMessageLogVO> {

	@AfterMapping
	default void afterToVO(SysMessageLog entity, @MappingTarget SysMessageLogVO vo) {
		if (entity.getStatus() != null) {
			vo.setStatusLabel(BaseEnum.getNameByCode(SuccessStatus.class, entity.getStatus()));
		}
	}
